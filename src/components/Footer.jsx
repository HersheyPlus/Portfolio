...
function Footer() {
  return (
    ...
    <div className='grid grid-cols-1 tablet:grid-cols-2 px-12 py-6 gap-y-8'>
      ...
      <div className='flex gap-x-10' id='message-to-me'>
        ...
        <input type="email" id="email" className="rounded-sm border w-3/5 bg-dark/40 px-3  py-1 font-roboto" placeholder='Email'/>
