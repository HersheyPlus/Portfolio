    ...
    className="border-4 border-green-2 rounded-xl overflow-hidden group relative">
          {isMobileScreen ? (
            <>
              ...
              />
              <div className="absolute -bottom-full left-5 group-hover:bottom-12 transition-all duration-500 z-40 ">
              {projectName}
              </div>
              {/* Title */}
              <div className="absolute -bottom-full left-5 group-hover:bottom-6 transition-all duration-500 z-40 ">
                {using}
              </div>
            </>
          ) : (
            ...
            alt={alt}
          />
          <div className="absolute left-4 bottom-11 z-40 ">
            {projectName}
          </div>
          {/* Title */}
          <div className="absolute z-40 left-4 bottom-5 ">
            {using}
          </div>
            </>
          )}
