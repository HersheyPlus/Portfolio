  ...
  return (
    <section className="section" id="projects">
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-2 gap-x-3 gap-y-4 h-full tablet:h-[28rem]">
        <ProjectList  img={project1} alt="project 1" projectName="Admin Dashboard" using="React & Tailwind" />
        <ProjectList  img={project2} alt="project 2" projectName="E-commmerce" using="NextJs"/>
        <ProjectList  img={project1} alt="project 3" projectName="Networking" using="Docker"/>
        <ProjectList  img={project2} alt="project 4" projectName="Shark Ulta" using="Kubenetes"/>
      </div>
